...
The soruce codes are taken from kubernetes chart repo for [ChartMuseum](https://github.com/kubernetes/charts/tree/master/stable/chartmuseum) and have been modified in order to

* ChartMuseum can be installed into a non-default namespace
* A step-by-stpe installation instruction doc has been provided (see chartmuseum.md).
