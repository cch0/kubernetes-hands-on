...
The soruce codes are taken from kubernetes chart repo for [Jenkins](https://github.com/kubernetes/charts/tree/master/stable/jenkins) and have been modified in order to

* Use Storage Class for dynamic provisioning
* Jenkins can be installed into a non-default namespace
* Jenkins service account has limited permission (instead of __cluster-admin__)
* A step-by-stpe installation instruction doc has been provided (see Jenkins.md).
